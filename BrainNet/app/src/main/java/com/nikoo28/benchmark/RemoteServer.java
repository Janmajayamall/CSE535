...
public class RemoteServer extends AsyncTask<Void, Void, Void> {
    ...
    public RemoteServer(String serverAddress, String fileName, File file) {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        MainActivity.setRemoteServerTime(endTime - startTime);
    }
